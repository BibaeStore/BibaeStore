    ...
    return (
        <div className="space-y-8 pb-10">
            <div className="space-y-1.5">
                <h1 className="text-3xl font-heading font-bold text-gray-900 tracking-tight">Analytics</h1>
                <p className="text-gray-500 font-body text-sm uppercase tracking-[0.1em]">Store Performance</p>
            </div>
            ...
            <Card className="bg-white border-gray-200 rounded-[2.5rem] p-12 text-center shadow-sm min-h-[400px] flex flex-col items-center justify-center">
                ...
                <p className="text-gray-500 max-w-sm mx-auto">
                    The Analytics module is currently being built. Check back soon for updates.
                </p>
                <div className="mt-8">
