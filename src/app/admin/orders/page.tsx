            ...
            <body>
                <div style="border:2px solid #1a1a1a;min-height:14.5cm;display:flex;flex-direction:column;">
                    ...
                    <div style="background:#1a1a1a;padding:16px 20px;display:flex;align-items:center;justify-content:space-between;">
                        <div>
                            <img src="/assets/logo.png" alt="Habiba Minhas" style="height:28px;filter:brightness(0) invert(1);" onerror="this.style.display='none';this.nextElementSibling.style.display='block';" />
                    ...
                    <div style="background:#1a1a1a;padding:12px 20px;margin-top:auto;">
                        ...
                        <div style="display:flex;align-items:center;justify-content:space-between;">
                            ...
                            <div style="text-align:right;">
                                ...
                                <div style="font-size:8px;color:#666;">habibaminhas.com</div>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        {order.items && order.items.length > 0 && (
                                            <div className="flex -space-x-2 mb-2">
                                                {order.items.slice(0, 4).map((item: any, idx: number) => (
                                                    <div key={idx} className="w-8 h-8 rounded-md bg-gray-50 border-2 border-white overflow-hidden relative shadow-sm" style={{ zIndex: 4 - idx }}>
                                                ...
                                                {order.items.length > 4 && (
                                                    <div className="w-8 h-8 rounded-md bg-gray-100 border-2 border-white flex items-center justify-center text-[9px] font-bold text-gray-500" style={{ zIndex: 0 }}>
                                                        +{order.items.length - 4}
                                                    </div>
                                                )}
                                            </div>
                                ...
                                <Table className="min-w-[900px]">
                                    <TableHeader className="bg-gray-50/50 border-b border-gray-200">
                                        <TableRow className="hover:bg-transparent border-gray-200">
                                            ...
                                            <TableHead className="w-[100px] py-5 text-[10px] uppercase tracking-[0.2em] text-gray-400 font-bold">Items</TableHead>
                                                        ...
                                                        <div className="flex items-center">
                                                            <div className="flex -space-x-2">
                                                                {(order.items || []).slice(0, 3).map((item: any, idx: number) => (
                                                                    <div key={idx} className="w-9 h-9 rounded-lg bg-gray-50 border-2 border-white overflow-hidden relative shadow-sm" style={{ zIndex: 3 - idx }}>
                                                                        {item.product?.images?.[0] ? (
                                                                            <Image
                                                                                src={item.product.images[0]}
                                                                                alt={item.product?.name || 'Product'}
                                                                ...
                                                                {(order.items?.length || 0) > 3 && (
                                                                    <div className="w-9 h-9 rounded-lg bg-gray-100 border-2 border-white flex items-center justify-center text-[10px] font-bold text-gray-500" style={{ zIndex: 0 }}>
                                                                        +{(order.items?.length || 0) - 3}
                                                                    </div>
                                                                )}
                                                            </div>
