          ...
          >
            ...
            <div className="flex gap-3 mb-6">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className={`flex-1 py-4 text-sm font-body font-medium tracking-widest uppercase flex items-center justify-center gap-2 transition-all duration-300 shadow-md ${addedToCart ? "bg-green-600 text-background" : isAddingToCart ? "bg-gray-400 text-white cursor-wait" : "bg-gray-900 text-white hover:bg-gray-800 shadow-button hover:shadow-button-hover"}`}
              >
                {addedToCart ? (
