...
export const metadata = {
    title: 'About Us | Bibae Store',
    description: 'Learn more about Bibae Store, our story, mission, and commitment to quality fashion and baby products in Pakistan.',
    alternates: {
        canonical: '/about',
    },
};
    ...
    return (
        <div className="bg-white text-gray-900 font-body">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="leading-relaxed text-gray-600">
                            Welcome to <strong>Bibae Store</strong>, your premier destination for premium fashion and baby products in Pakistan. We believe that style shouldn't come at the cost of comfort, and quality shouldn't break the bank.
                        </p>
                        <p className="leading-relaxed text-gray-600">
                            Founded with a passion for excellence, Bibae Store started as a small vision to bring curated, high-quality items to families who appreciate the finer details. Today, we are proud to serve thousands of happy customers across the region.
                        </p>
                        <div className="pt-4">
            ...
            <section className="py-20 bg-primary text-white text-center">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-heading font-bold mb-6">Join the Bibae Family</h2>
