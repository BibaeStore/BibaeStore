...
function buildTimeline(order: Order): TimelineStep[] {
    ...
    // If payment was rejected, insert a rejection step after "Order Placed"
    if (isPaymentRejected) {
        // Find the rejection timestamp from history
        ...
        // Insert after "Order Placed" (index 1), replacing the normal flow
        steps.splice(1, 0, rejectionStep)

        // Mark remaining steps as not completed
