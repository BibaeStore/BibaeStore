...
export const metadata = {
    title: 'Refund & Return Policy | Bibae Store',
    description: 'Our policies regarding refunds and returns for products purchased at Bibae Store.',
    alternates: {
        ...
        <div className="bg-white min-h-screen text-gray-900 font-body py-12 md:py-20">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="prose prose-lg max-w-none prose-headings:font-heading prose-headings:text-primary prose-a:text-primary">
                    ...
                    <p>
                        If you received a damaged product, please notify us immediately for assistance. Contact us at <a href="mailto:support@bibaestore.com">support@bibaestore.com</a> with a photo of the damage.
                    </p>
                    ...
                    <p>
                        <strong>Email:</strong> support@bibaestore.com <br />
