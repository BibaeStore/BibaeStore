...
export const metadata = {
    title: 'Affiliate Program | Bibae Store',
    description: 'Join the Bibae Store Affiliate Program and earn commissions.',
    alternates: {
        ...
        <div className="bg-white min-h-screen text-gray-900 font-body py-12 md:py-20">
            <div className="container mx-auto px-4 max-w-4xl text-center">
                ...
                <div className="max-w-xl mx-auto">
                    ...
                    <a href="mailto:affiliates@bibaestore.com" className="inline-block bg-primary text-white px-8 py-3 rounded-full font-semibold hover:bg-primary/90 transition-colors shadow-lg">
                        Email Us to Apply
                    </a>
                </div>
            </div>
