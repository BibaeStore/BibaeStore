          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { href: "https://www.quora.com/profile/Habiba Minhas-Store", icon: <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12.73 18.77c-.78-1.58-1.74-3.16-3.28-3.16-.57 0-1.09.22-1.35.63l-.93-.76c.67-1.01 1.8-1.53 3.19-1.53 1.86 0 3.09.98 4.03 2.5.36-1.27.53-2.87.53-4.77 0-5.82-1.78-8.95-5.02-8.95-3.2 0-4.96 3.13-4.96 8.95 0 5.86 1.76 8.92 4.96 8.92.73 0 1.38-.14 1.94-.42l.89-.41zM9.9 22C5.03 22 1.5 18.13 1.5 11.68 1.5 5.2 5.03 1.32 9.9 1.32c4.88 0 8.4 3.88 8.4 10.36 0 2.25-.34 4.18-.97 5.74 1.01 1.46 2.07 2.13 3.36 2.13.43 0 .79-.07 1.06-.16l.53 1.46c-.6.35-1.38.55-2.32.55-2.04 0-3.6-1.1-4.81-2.89-1.37 1.01-3.11 1.49-5.25 1.49z"/></svg>, label: "Quora" },
                { href: "https://www.linkedin.com/company/bibae-store/", icon: <Linkedin className="w-4 h-4" />, label: "LinkedIn" },
